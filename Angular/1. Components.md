...
- Anatomy (a.k.a component metadata)
	...
	- selector: CSS Selector that defined how the component is used in HTML, case-sensitive, never use `ng-` prefix, kebab-case
	- styles / styleUrl
	- standalone
	- encapsulation
	- providers
...
- return type of the transform should be the basis of the type of the input
```ts
@Component({
