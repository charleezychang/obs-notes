...
- 2 types: attribute and structural, 1 specialized: components (directive with a template)
- components are actually directives, since they are used to reuse UI elements which matches the description of what a directive is
